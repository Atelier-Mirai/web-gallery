web-gallery/sample/を参照してください。1/から12/までのサンプルサイトが用意されています。
このうち 1/から9/まではリファクタリングが完了しています。
10/, 11/, 12/ のリファクタリングを行ってください。
（必要でしたら、1/から9/まででどのようなリファクタリングを行ったかを参考にしてください。）
